...
<html>
	...
	<body background="<%=aspDir%>/include/images/graph.gif">
		...
		<table border=0 cellspacing=0 cellpadding=0 width=100%>
			<tr>
				<td align="left">
					<img src="<%=aspDir%>/include/images/asplogo.jpg" border=none>
				</td>
				<td align="right">
		...
		<table BORDER="0" bgcolor="#000000" WIDTH="100%" cellspacing=0
			...
			<tr>
				<td width=100% ALIGN=RIGHT>
					...
					<%
						} else if (mySession.getAttribute("mySystem")
									.equals("purchase")) {
					%>
					...
					<%
						} else if (mySession.getAttribute("mySystem").equals(
									"chemistry")) {
					%>
					<%@ include file="/chemistry/ChemistryMenu.jsp"%>
					<%
