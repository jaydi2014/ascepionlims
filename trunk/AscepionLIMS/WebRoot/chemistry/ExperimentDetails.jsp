...
<table width="100%">
	<tr>
		...
		<td align="right" valign="bottom" width="5%">
			<form name="editExperiment"
				action="<%=aspDir%>chemistry/EditExperiment.jsp" method="post">
		...
		<td align="right" valign="bottom" width="5%">
			<form name="printExperiment"
				action="<%=aspDir%>chemistry/PrintExperimentPage.jsp" method="post">
				<input type="hidden" name="reactionid" value="<%= reactionId%>">
				<input type="hidden" name="experimentid" value="<%= experimentId%>">
				<input type="submit" name="create" value="Report&Print">
			</form>
		</td>
	</tr>
</table>
