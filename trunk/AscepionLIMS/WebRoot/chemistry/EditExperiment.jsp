...
<hr>
<br />
<form name="myForm" action="<%=aspDir%>chemistry/ProcessEditExperimentInput.jsp"
	...
	<table width="100%">
		...
		<tr>
			<th align="left">
				Experiment Name:
				<input type="text" name="experimentName" size="20" value="<%=FormatterFeeder.validateNull(experiment.getName())%>" />
			</th>
			<th align="right">
				Date:
				...
				<input type="text" name="experimentDate" size="20"
					readonly="readonly" value="<%=FormatterFeeder.validateNull(DateFeeder.parseDate(
							experiment.getDate(), "MM/dd/yyyy"))%>" />
			</th>
		</tr>
		<tr>
			<th align="left">
			...
			<th align="right">
				...
				<input type="text" name="temperature" size="2" value="<%=FormatterFeeder.validateNull(experiment.getTemperature())%>" />
				<sup>
					o
				</sup>
				C / RH
				<input type="text" name="humidity" size="2" value="<%=FormatterFeeder.validateNull(experiment.getHumidity())%>" />
				%
			</th>
		</tr>
	</table>
	...
	<center>
		...
		<table width="100%" id="rawRatio" cellpadding="0" cellspacing="0">
			...
			<tr align="center">
				<td>
					<input type="text" name="<%=i%>1" size="20" value="<%=FormatterFeeder.validateNull(raw.get(0))%>" />
				</td>
				<td>
					<input type="text" name="<%=i%>2" size="20" value="<%=FormatterFeeder.validateNull(raw.get(1))%>" />
				</td>
				<td>
					<input type="text" name="<%=i%>3" size="20" value="<%=FormatterFeeder.validateNull(raw.get(2))%>" />
				</td>
				<td>
					<input type="text" name="<%=i%>4" size="20" value="<%=FormatterFeeder.validateNull(raw.get(3))%>" />
				</td>
				<td>
					<input type="text" name="<%=i%>5" size="20" value="<%=FormatterFeeder.validateNull(raw.get(4))%>" />
				</td>
				<td>
					<input type="text" name="<%=i%>6" size="20" value="<%=FormatterFeeder.validateNull(raw.get(5))%>" />
				</td>
			</tr>
			<%
				}
	...
	<textarea name="process" rows="20" cols="100%" ><%=FormatterFeeder.validateNull(experiment.getProcess())%></textarea>
	<br>
	<br>
	...
	<br>
	<span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span>
	<textarea name="comment" rows="10" cols="100%" ><%=FormatterFeeder.validateNull(experiment.getComment())%></textarea>
	<br>
	<br>
	...
	<br>
	<span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span>
	<textarea name="result" rows="10" cols="100%" ><%=FormatterFeeder.validateNull(experiment.getResult())%></textarea>
	<br>
	<br>
	<center>
