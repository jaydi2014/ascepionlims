...
<center>
	<form name="myForm" action="<%=aspDir%>chemistry/DeleteReaction.jsp"
		method="post" onsubmit="return validateDeleteReaction()">
		...
		<br />
		<br />
		<input name="submit" type="submit" value="Delete this reaction" />
	</form>