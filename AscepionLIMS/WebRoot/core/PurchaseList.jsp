...
<table>
	<tr>
		<td>
			<h5>
				Purchase List:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
		...
		<td>
			<select name="IsApproved" onchange="displayRow('purchase',this)">
				<option value="" selected>--IsApproved--</option>
				<option value="Yes">Yes</option>
				<option value="No">No</option>
	        </select>
		</td>
		<td>
			<button onclick="showAllRow('purchase')">ShowAll</button>
		</td>
	</tr>
</table>
<hr>
