...
public class PermissionRepository extends LIMSRepository implements Destroyable,
	...
	public void prepareCalls(Connection conn) throws RepositoryException {
		String get = "SELECT L.PAGE_ID,L.PAGE_NAME,P.EMPLOYEETYPE_ID,P.GRANTED FROM PERMISSIONS P,LIMS_PAGE L WHERE L.PAGE_ID=P.PAGE_ID AND P.EMPLOYEETYPE_ID=? ORDER BY PAGE_ID";
		this.sqlCreate = " ";
		this.sqlUpdate = " ";
		this.sqlRemove = " ";
